...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
    ...
    <div class="mb-8">
        <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/20">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Kasir Baru</h1>
                    <p class="text-gray-600">Tambahkan kasir baru untuk Agam Store</p>
                </div>
    ...
    <div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 p-8">
        <form action="{{ route('admin.kasir.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <!-- Role Field (Hidden - Auto set to kasir) -->
